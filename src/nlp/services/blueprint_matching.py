...
def match_blueprints(nlp_output, blueprints_corpus):
  ...
  for category, category_blueprints in blueprints_by_category.items():
    ...
    for blueprint in category_blueprints:
      ...
      # or if the number of matched tags is equal to the max number of matched tags and the total number of tags is less than the minimum number of total tags
